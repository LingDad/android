...
public class NumberCircleProgressBar extends View {
	private static CircleProgressBarListener mCircleProgressListener;
	...
	private void calculateDrawRectF() {
		...
		Log.e("circle", "mCircleRectF left: " + mCircleRectF.left);
		Log.e("circle", "mCircleRectF top: " + mCircleRectF.top);
		Log.e("circle", "mCircleRectF right: " + mCircleRectF.right);
		Log.e("circle", "mCircleRectF bottom: " + mCircleRectF.bottom);
	}
	...
	public void incrementProgressBy(int by, String key) {
		if (by > 0) {
			int progress = getProgress() + by;
			setProgress(progress > getMax() ? getMax() : progress);
			if(progress >= 100 && mCircleProgressListener != null){
				mCircleProgressListener.OnCircleProgressBarDone(key);
			}
		}
	}
	...
	public void setOnCircleProgressListener(CircleProgressBarListener listener){
		
		mCircleProgressListener = listener;
	}
